    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-card-head p { font-size: 0.78rem; color: #94a3b8; margin-top: 0.3rem; }

        .auth-divider { height: 1px; background: #f1f5f9; margin: 1.25rem 0 0; }
        ...
        .auth-success strong { display: block; font-weight: 600; margin-bottom: 0.2rem; }
        ...
        <div className="auth-body">
          <div className="auth-card">
            <div className="auth-card-head">
              ...
              <p>Empezá a registrar tus gastos hoy</p>
